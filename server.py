...
gpgcheck=0""")
			...
			def aws():
				...
				print("""
					 ...
					 Press  17 :To create Snapshot
					 Press  18 :To create Cloud Front Distributions
					 Press  19 :Back""")
				...
				if int(ch) == 1:
					...
					if int(img) ==1:
						...
						print("\nEnter Your Security Group name: ",end ="")
						key1 = input()
						os.system("aws ec2 run-instances --image-id ami-052c08d70def0ac62 --instance-type t2.micro --key-name {} --security-group-ids {} --count 1".format(key))
				elif int(ch) == 6:
